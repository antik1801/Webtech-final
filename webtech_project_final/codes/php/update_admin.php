...
<html>
	<head><h1><u>Update Admins</u></h1></head>
	<?php
	   ...
	   if (isset($_POST["register"])) {
			  ...
			  $query = "update register set name = '$name' , did = '$did' , dep = '$dep', des='$des', pass ='$pass',gender='$gender',city='$city',fname='$fname',mname='$mname',nid='$nid',dob='$dob',dl='$dl' where uname='$uname'";
			  //echo $query;
			  runQuery($query);
	...
	<body>
		...
		<script src="js/validate_addadmin.js"></script>
	</body>
</html>